...
class SingerKalmanTracker(object):
    ...
    def __init__(self, det, wx, wy, vmax,dt=1/30,H=None,H_P=None,H_Q=None,alpha_cov=1,InvA_orig=None,maneuver_time=2,t1=0.9,t2=0.9):
    ...
    def update(self, y, R, relative_iou, relative_p):
        ...
        self.H_Q = np.mean(self.innov_list, axis=0)[-8:, -8:]
    ...
    def compute_mixed_initial(self):
        ...
        g_pos, sigma_rg, jac = self.uv2xy(last_feet, self.R[2:4, 2:4], self.kf.P[-8:, -8:])
